...
export const ContactCard = (props) => {
    ...
    const modalID = `modal${props.contactid}`
        ...
        <div className="container d-flex justify-content-between contCard p-3">
            <div className="d-flex leftSide">
                ...
                <div className="props">
                    ...
                    <h5><FontAwesomeIcon icon={faLocationDot} />    {props.address}</h5>
                    <p><FontAwesomeIcon icon={faPhone} /> {props.phone}</p>
                    <p><FontAwesomeIcon icon={faEnvelope} /> {props.email}</p>
                </div>
            </div>
            <div>
                <button className="contButton" value={props.contactid} data-bs-toggle="modal" data-bs-target={`#${modalID}`} onClick={handleModal}><FontAwesomeIcon icon={faPencil} /></button>
                <button className="contButton" value={props.contactid} onClick={deleteContact}><FontAwesomeIcon icon={faTrash} /></button>
            </div>
